...
int main(int argc, char** argv)
{
	...
	if (argc != 11) {
		cout << endl << "Usage: ./qicsieve2d inputpoly fbbits factorbasefile B1 B2 qmin qmax th0 lpbbits cofmaxbits" << endl << endl;
		return 0;
	}
	...
	if (verbose) cout << "There are " << k0 << " factor base primes." << endl;
	fbfile.close();
